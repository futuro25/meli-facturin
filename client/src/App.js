        ...
        <div className="flex gap-2 items-center cursor-pointer" onClick={() => window.location.assign('/')}>
          {
            ...
            <>
              ...
              <h1 className="inline-block text-2xl sm:text-3xl text-white pl-2 tracking-tight ">Meli</h1>
            </>
          }
          {
            config.isDevelop &&
...

          {
            config.isLocal &&
            <>
              <h1 className="inline-block text-2xl sm:text-3xl text-white pl-2 tracking-tight">Local - Meli</h1>
            </>
          }
